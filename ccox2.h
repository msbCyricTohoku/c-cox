...
//void U_I_Calc(DATA *data, int N, int tie_handling, int COVNO,
//              double beta[COVNO], double U[COVNO], double I[COVNO][COVNO],
//              double **Z, double *TiE1, int E1, int event_code);

//void  U_I_Calc(DATA *data, int N, int tie_handling, int COVNO, double beta[COVNO], double U[COVNO], double I[COVNO][COVNO], double **Z, double *TiE1, int E1, int event_code, ccox_SortItem *stop_items, ccox_SortItem *start_items, ccox_SortItem *event_items, int num_events);
